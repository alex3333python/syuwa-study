      ...
      LessonStep(
        ...
        questions: [
          _q(
            ...
            explanationRuby:
                '13 - 12 = 1 なので、1こ{余ります|あまります}。だから、13 ÷ 4 = 3 あまり 1 です。',
            formulaExplanation:
                '13 ÷ 4 は、13を4つずつ分けるという意味です。\n3は、4つずつのまとまりの数です。\nあまりの1は、分けきれずに残った数です。',
            formulaExplanationRuby:
                '13 ÷ 4 は、13こを4{人|にん}に{同じ数|おなじかず}ずつ{分ける|わける}という{意味|いみ}です。\n{答え|こたえ}の3は、1{人分|ひとりぶん}の{数|かず}です。\nあまりの1は、{分け|わけ}きれずに{残った|のこった}{数|かず}です。',
          ...
          _q(
            ...
            questionTextRuby: '17を5でわると、3こずつ{作れて|つくれて}、{何こ|なんこ}{残ります|のこります}か。',
            choices: ['1', '2', '3', '5'],
            correct: 1,
