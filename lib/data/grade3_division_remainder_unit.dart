      ...
      LessonStep(
        ...
        questions: [
          _q(
            ...
            questionTextRuby: '12こを4こずつ{分|わ}けると、あまりはありますか。',
            choices: ['ある', 'ない'],
            correct: 1,
            explanation: '12 ÷ 4 = 3 で、ぴったり分けられます。',
            explanationRuby: '12 ÷ 4 = 3 で、ぴったり{分|わ}けられます。',
            vocabulary: ['ぴったり', 'わりきれる'],
            tags: ['remainder_check'],
            native: {
              AppLanguage.portuguese:
                  'Se dividirmos 12 em grupos de 4, sobra alguma coisa?',
            },
            nativeExplanation: {
              AppLanguage.portuguese:
                  '12 ÷ 4 = 3. Dá para dividir certinho, sem resto.',
            },
            equationHint: '12 ÷ 4 = 3',
          ...
          _q(
            ...
            questionTextRuby: '14こを4こずつ{分|わ}けると、あまりはありますか。',
            choices: ['ある', 'ない'],
            correct: 0,
            explanation: '14 ÷ 4 = 3 あまり 2 です。',
            explanationRuby: '14 ÷ 4 = 3 あまり 2 です。',
            vocabulary: ['わりきれない'],
            tags: ['remainder_check'],
            native: {
              AppLanguage.portuguese:
                  'Se dividirmos 14 em grupos de 4, sobra alguma coisa?',
            },
            nativeExplanation: {AppLanguage.portuguese: '14 ÷ 4 = 3, resto 2.'},
      ...
      LessonStep(
        ...
        questions: [
          ...
          _q(
            ...
            questionTextRuby: '22cmのひもを4cmずつ{切|き}るなら、4cmのひもは{何本|なんぼん}できますか。',
            choicesRuby: ['5{本|ほん}', '6{本|ぽん}', '2{本|ほん}'],
            choices: ['5本', '6本', '2本'],
            correct: 0,
            explanation: '22÷4=5 あまり2。あまり2cmは4cmに足りないので、5本です。',
            explanationRuby: '22÷4=5 あまり2。あまり2cmは4cmに{足|た}りないので、5{本|ほん}です。',
            vocabulary: ['足りない', '本'],
            tags: ['ignore_remainder_context'],
            native: {
              AppLanguage.portuguese:
                  'Cortamos uma corda de 22 cm em pedaços de 4 cm. Quantos pedaços de 4 cm conseguimos fazer?',
            },
            nativeExplanation: {
              AppLanguage.portuguese:
                  '22 ÷ 4 = 5, resto 2. Os 2 cm que sobram não chegam a 4 cm, então são 5 pedaços.',
            },
            equationHint: '22 ÷ 4 = 5 あまり 2',
            visualType: QuestionVisualType.divisionRemainder,
            itemEmoji: '📏',
      ...
      LessonStep(
        ...
        questions: [
          _q(
            id: 12501,
            type: 'remainder_calculation',
            school: '19 ÷ 6 のあまりはいくつですか。',
            easy: '19を6でわります。あまりはいくつですか。',
            choices: ['1', '2', '7'],
            correct: 0,
            explanation: '6×3=18、19-18=1 なので、あまりは1です。',
            explanationRuby: '6×3=18、19-18=1 なので、あまりは1です。',
            vocabulary: ['計算'],
            tags: ['remainder_calculation'],
            equationHint: '19 ÷ 6 = 3 あまり 1',
            visualType: QuestionVisualType.divisionRemainder,
          ...
          _q(
            id: 12502,
            type: 'select_equation',
            school: '34こを5こずつ分けます。式はどれですか。',
            easy: '34こを5こずつにします。どの式ですか。',
            choices: ['34÷5', '34×5', '34−5'],
            correct: 0,
            explanation: '全部の34こを、5こずつ分けるので、式は34÷5です。',
            explanationRuby: '{全部|ぜんぶ}の34こを、5こずつ{分|わ}けるので、{式|しき}は34÷5です。',
            vocabulary: ['式'],
