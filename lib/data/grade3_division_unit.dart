  ...
  Lesson(
    ...
    steps: [
      _learn(
        ...
        title: '学習しよう',
        school:
            '6このいちごを3人で同じ数ずつ分けます。いちごを1こずつ3人のお皿に置き、もう一度1こずつ置くと、どのお皿も2こになります。6 ÷ 3 = 2 と書き、「6わる3は2」と読みます。1人分を知りたいときに使う計算が、わり算です。',
      ...
      LessonStep(
        ...
        questions: [
          ...
          _q(
            ...
            correct: 0,
            explanation: 'ぜんぶの20こを4人で分けるので、式は20 ÷ 4です。',
            vocabulary: ['式', '同じ数ずつ', '分ける'],
            tags: ['equal-sharing', 'select_equation'],
            equationHint: '20 ÷ 4',
            formulaExplanation: '20はぜんぶの数、4は分ける人数です。ぜんぶの数 ÷ 人数で考えます。',
  ...
  Lesson(
    ...
    steps: [
      _learn(
        ...
        title: '学習しよう',
        school:
            '6このいちごがあります。1人に2こずつ分けます。2こずつのまとまりを作ると、3人分できます。6 ÷ 2 = 3 と書きます。6はぜんぶの数、2は1人分の数、3は分けられる人数です。',
      ...
      LessonStep(
        ...
        questions: [
          ...
          _q(
            ...
            correct: 0,
            explanation: 'ぜんぶの24こを、1人分の4こで分けるので、式は24 ÷ 4です。',
            vocabulary: ['何人に分けられる', '式'],
            tags: ['measurement-division', 'select_equation'],
            equationHint: '24 ÷ 4',
            formulaExplanation: '24はぜんぶの数、4は1人分の数です。ぜんぶの数 ÷ 1人分の数で考えます。',
  ...
  Lesson(
    ...
    steps: [
      _learn(
        ...
        easy: '0を分けると答えは0です。1人で分けると、ぜんぶその人の分です。同じ数の人で分けると、1人分は1です。',
      ),
      _learn(
      ...
      LessonStep(
        ...
        questions: [
          ...
          _q(
            ...
            choices: ['1', '5', '6', '7'],
            correct: 2,
            explanation: '6こを1人で分けるので、ぜんぶその人の分です。6 ÷ 1 = 6 です。',
            vocabulary: ['1でわる', '1人分'],
      ...
      LessonStep(
        ...
        questions: [
          _q(
            ...
            choices: ['0÷4', '4÷0', '4÷4'],
            correct: 0,
            explanation: 'ぜんぶの数が0こなので、式は0 ÷ 4です。0でわる式は選びません。',
            vocabulary: ['0', '正しい式'],
  ...
  Lesson(
    ...
    steps: [
      _learn(
        ...
        title: '学習しよう',
        school:
            '文章題では、まず「ぜんぶの数」を見つけます。次に、「何人で分ける」か、または「何こずつ分ける」かを見つけます。最後に、わり算の式にします。',
      ...
      LessonStep(
        ...
        questions: [
          _q(
            ...
            equationHint: '27 ÷ 9',
            formulaExplanation: '27はぜんぶの数、9は分ける人数です。式は27 ÷ 9です。',
      ...
      LessonStep(
        ...
        questions: [
          _q(
            ...
            choices: ['何人に分けられるか', '1人分は何こか', 'ぜんぶで何こか'],
            correct: 0,
          ...
          _q(
            ...
            correct: 0,
            explanation: 'ぜんぶの28こを4人で分けるので、式は28 ÷ 4です。',
            vocabulary: ['1人分', '式'],
            tags: ['equal-sharing', 'select_equation'],
            equationHint: '28 ÷ 4',
            formulaExplanation: '28はぜんぶの数、4は分ける人数です。',
  ...
  Lesson(
    ...
    steps: [
      ...
      LessonStep(
        ...
        questions: [
          ...
          _q(
            ...
            formulaExplanation:
                '6本の木には、間が5つあります。ぜんぶの長さ30m ÷ 間の数5 = 1つ分の長さ6mです。',
      ...
      _summary(
        ...
        school: 'あまりのないわり算では、ぜんぶの数を同じ数ずつ分けたり、1人分を決めて分けたりできます。',
