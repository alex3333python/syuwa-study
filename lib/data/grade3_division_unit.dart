      ...
      LessonStep(
        ...
        questions: [
          ...
          _q(
            ...
            questionTextRuby:
                '12このあめを3{人|にん}で{同じ数|おなじかず}ずつ{分けます|わけます}。1{人分|ひとりぶん}は{何こ|なんこ}ですか。',
            choices: ['3', '4', '9', '15'],
            correct: 1,
            explanation: '12 ÷ 3 = 4。1人分は4こです。',
            explanationRuby: '12 ÷ 3 = 4。1{人分|ひとりぶん}は4こです。',
            formulaExplanationRuby:
                '12 ÷ 3 は、12こを3{人|にん}に{同じ数|おなじかず}ずつ{分ける|わける}という{式|しき}です。',
            languagePointRuby:
                '「{同じ数|おなじかず}ずつ」は、1{人|にん}1{人|にん}が{同じ数|おなじかず}になるという{意味|いみ}です。',
      ...
      LessonStep(
        ...
        questions: [
          ...
          _q(
            ...
            questionTextRuby: '「{同じ数|おなじかず}ずつ」とはどんな{意味|いみ}ですか。',
            ...
            explanationRuby:
                '「{同じ数|おなじかず}ずつ」は、1{人|にん}1{人|にん}の{数|かず}が{同じ|おなじ}になることです。',
            vocabulary: ['同じ数ずつ'],
